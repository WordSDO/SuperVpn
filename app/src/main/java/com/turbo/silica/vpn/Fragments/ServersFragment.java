...
import com.turbo.silica.vpn.Adapters.TabsAdapter;
            ...
            public void success(@NonNull final AvailableCountries countries) {
                ...
                for (Country country :
                    ...
                    if (locale.getDisplayCountry().equalsIgnoreCase("Unknown server")) {
                            ...
                            locale.getDisplayCountry().equalsIgnoreCase("singapore")
                ...
                adapter.addFragment(VipServersFragment.createInstance(), "Free VIP Servers");
